...
/*
 * The new concept here was using a HashMap to store elements as we iterate
 * through the array to look for a complement, reducing the need for a nested
 * loop. Challenges: Ensuring the correct indices are returned and avoiding
 * duplicate checks of the same element was important. Future use: I'll
 * definitely use this approach for future problems where we need to search for
 * specific elements quickly, as hash maps are very efficient for lookups
 */
